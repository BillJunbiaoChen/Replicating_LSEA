...
##########################################################################################
# PART 1, SEED 1243, NO FIXED EFFECTS
##########################################################################################
...
##########################################################################################
# PART 2, SEED 1234, NO FIXED EFFECTS
##########################################################################################
using Random, Distributions, LinearAlgebra, Optim, ForwardDiff, CSV, DataFrames, StatsBase, Distributed
# Fix seed for reproducibility
Random.seed!(1234)
...
for ξ_c in ξ_to_consider
    for J in J_to_consider
        for Pop in Pops_to_consider
                ...
                Threads.@threads for k=5:(n_iter+5)
...
##########################################################################################
# PART 1, SEED 1243, WITH FIXED EFFECTS
##########################################################################################
# Fix seed for reproducibility
Random.seed!(1243)
...
##########################################################################################
# PART 2, SEED 1234, WITH FIXED EFFECTS
##########################################################################################
# Fix seed for reproducibility
Random.seed!(1234)
